...
# -----------------------------------------------------------------------------
BUILDING_GROUPS = {
    '1':  {'name': 'Vadász',          'label': '1',  'x': 28.8, 'y': 41.2, 'rooms': ['Vadász Room 1', 'Vadász Room 2']},
    '2':  {'name': 'Füzi',            'label': '2',  'x': 34.0, 'y': 39.2, 'rooms': ['Füzi Room 1', 'Füzi Room 2']},
    '3':  {'name': 'Fa',              'label': '3',  'x': 38.8, 'y': 37.2, 'rooms': ['Fa Room 1', 'Fa Room 2']},
    '4':  {'name': 'Nagyház (Rubin)', 'label': '4',  'x': 45.5, 'y': 30.0, 'rooms': ['Rubin Room 1', 'Rubin Room 2', 'Rubin Room 3', 'Rubin Room 4']},
    '5':  {'name': 'Aurum',           'label': '5',  'x': 53.0, 'y': 32.0, 'rooms': ['Aurum Room 1', 'Aurum Room 2']},
    '6':  {'name': 'Nóra',            'label': '6',  'x': 58.6, 'y': 30.0, 'rooms': ['Nóra Room 1', 'Nóra Room 2']},
    '7':  {'name': 'Ágnes',           'label': '7',  'x': 64.8, 'y': 28.5, 'rooms': ['Ágnes Room 1', 'Ágnes Room 2']},
    '8':  {'name': 'Béla Ház',        'label': '8',  'x': 70.5, 'y': 27.0, 'rooms': ['Béla Ház']},
    '9':  {'name': 'VIP Ház',         'label': '9',  'x': 5.8,  'y': 55.2, 'rooms': ['VIP 1','VIP 2','VIP 3','VIP 4','VIP 5','VIP 6','VIP 7','VIP Fsz 1','VIP Fsz 2']},
    '10': {'name': 'Attila Ház',      'label': '10', 'x': 82.8, 'y': 54.2, 'rooms': ['Attila Ház 1', 'Attila Ház 2']},
    'A':  {'name': 'Sátor A',         'label': 'A',  'x': 19.5, 'y': 39.5, 'rooms': ['Sátor A']},
    'B':  {'name': 'Sátor B',         'label': 'B',  'x': 16.0, 'y': 45.0, 'rooms': ['Sátor B']},
    'C':  {'name': 'Sátor C',         'label': 'C',  'x': 11.0, 'y': 49.0, 'rooms': ['Sátor C']},
    'D':  {'name': 'Sátor D',         'label': 'D',  'x': 13.0, 'y': 55.5, 'rooms': ['Sátor D']},
    'E':  {'name': 'Sátor E',         'label': 'E',  'x': 21.5, 'y': 52.5, 'rooms': ['Sátor E']},
    'F':  {'name': 'Sátor F',         'label': 'F',  'x': 17.0, 'y': 60.5, 'rooms': ['Sátor F']},
    'G':  {'name': 'Sátor G',         'label': 'G',  'x': 12.8, 'y': 65.8, 'rooms': ['Sátor G']},
    'H':  {'name': 'Sátor H',         'label': 'H',  'x': 22.0, 'y': 63.0, 'rooms': ['Sátor H']},
    'K':  {'name': 'Külsős Vendégek', 'label': '👤', 'x': 31.0, 'y': 17.5, 'rooms': ['Külsős (Nincs)', 'Külsős (Sátor)', 'Külsős (Lakókocsi)']},
}
